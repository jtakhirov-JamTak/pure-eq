...
// flows in the codebase (Anthropic, OpenAI, Supabase, Stripe, Sentry, Vercel).
const UPDATED = "2026-06-08";

const SUBPROCESSORS: { name: string; purpose: string; data: string }[] = [
  { name: "Supabase", purpose: "Database, authentication, hosting", data: "Account, profile, all entries & conversations" },
  { name: "Anthropic (Claude)", purpose: "AI coaching feedback", data: "The text you submit for coaching" },
  { name: "OpenAI (Whisper)", purpose: "Voice-to-text transcription", data: "Audio you record in voice fields" },
  { name: "Stripe", purpose: "Payment processing (coin purchases)", data: "Payment details (handled by Stripe)" },
    ...
    <div className="relative min-h-dvh px-5 pb-24 pt-[max(2rem,env(safe-area-inset-top))]">
      ...
      <div className="mx-auto w-full max-w-2xl">
        ...
        <Section title="Who we are">
          <p>
            SpeakEasy (&ldquo;we&rdquo;) is an emotional-intelligence coaching
            app. This policy explains what personal data we collect, how we use
            it, and the choices you have. Contact: [your support email].
          </p>
        </Section>

        <Section title="What we collect">
          <p>
            Account information (email, first name); your Communication Profile
            quiz answers; and the content you create in the app — conversation
            entries, reflections, and coaching inputs. This content can be
            sensitive (emotions, relationships, personal situations). If you use
            voice input, we send the audio for transcription.
          </p>
        </Section>

        <Section title="How we use it">
          <p>
            To provide the coaching features you request, generate AI feedback,
            transcribe voice input, process purchases, keep the service running,
            and diagnose errors. We do not sell your personal data.
          </p>
        </Section>
