...
// replace with lawyer-reviewed copy before launch. The not-a-substitute-for-
// professional-care disclaimer matters given the app's emotional-support domain.
    ...
    <div className="relative min-h-dvh px-5 pb-24 pt-[max(2rem,env(safe-area-inset-top))]">
      ...
      <div className="mx-auto w-full max-w-2xl">
        ...
        <Section title="Acceptance">
          <p>
            By creating an account or using SpeakEasy (&ldquo;the service&rdquo;)
        ...
        <Section title="Not professional or medical advice">
          <p>
            SpeakEasy is a self-help coaching tool. It is{" "}
            <span className="font-semibold text-ink">not</span> therapy, medical,
            or mental-health treatment, and does not replace care from a
            qualified professional. If you are in crisis or may harm yourself or
            others, contact emergency services or a crisis line immediately.
          </p>
        </Section>
        ...
        <Section title="Coins & payments">
          <p>
            Some features use coins, bought as one-time purchases via Stripe.
            Pricing is shown before purchase. [State your refund policy and that
            coins are not a subscription, consistent with the in-app pricing.]
          </p>
        </Section>
