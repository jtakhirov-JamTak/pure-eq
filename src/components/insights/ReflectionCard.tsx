    ...
    <div className="mt-4 rounded-card-sm bg-surface p-5 shadow-soft">
      ...
      <div className="mt-4 space-y-5">
        {reflection.observations.map((obs, i) => (
          <div key={i} className="border-t border-zinc-200 pt-4 first:border-0 first:pt-0">
            ...
            <div className="mt-3 space-y-2">
              {obs.evidence.map((ev, j) => (
                <blockquote
                  key={j}
                  className="border-l-2 border-brand-soft pl-3 text-[12px] italic leading-[1.5] text-ink-soft"
                >
